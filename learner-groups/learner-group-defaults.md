...
Using the mouse to hover over the subgroups listing and the "needs accommodation" icon will reveal a callout box detailing which sub groups need accommodation. This is shown below. 
