...
This area appears at the top of the Course page. It includes everything listed below. 
  ...
  - **Back to Courses List:** link back to [Courses and Sessions](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions)
...
2. [**Global Search**](https://iliosproject.gitbook.io/ilios-user-guide/dashboard/search): search for anything in Ilios
...
14. [**Visualizations**](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/visualizations): opens up Visualizations (Graphs) for the selected course
...
![course detail - lower](../../images/course_images/course_detail_lower.png)
...
3. [**Manage MeSH**](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/mesh_terms): allows user to manage MeSH terms associated with this course
4. [**Manage Cohorts**](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/program_cohorts): to add or remove program cohorts from the selected course
...
* **Course Title** - default sort order (A-Z)
* **Level**
* **Start Date**
* **End Date**
* **Status**
...
"My Courses" has now been selected as a result of clicking the appropriate button.

![my courses selected](../../images/course_images/my_courses_selected.png)
...
![my courses list](../../images/course_images/my_courses_list.png)