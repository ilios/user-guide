...
**TIP:** It can be helpful to sort by **"Status"** when you want to find out which Courses may not have been published yet. Courses with the status of "Not Published" will appear in the list befor "Published" courses based on the A-Z sort order applied here.
