...
* **Timezone**: This was created for schools that may have campuses in different timezones or if an Ilios user happens to be using a computer that is set to an alternate zone. The timezone for the offering (regardless of the computer's settings) can be set here. The resulting saved offering will still be displayed using the computer's timezone settings.
...
* **Learner Groups**: This is how Students are assigned into Offerings. If a Student is a member of a Learner Group that is attached to an Offering, the Offering will appear on their calendar.
  * **Selected Learner Groups**: This frame is populated by any and all Learner Groups added to the offering.
  * **Available Learner Groups**: Learner Groups that are not associated with the offering yet are available for selection here.
...
![click to add offerings](../../images/offerings_README/click_to_add_offerings.png)
