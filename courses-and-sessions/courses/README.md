...
This refers to the other course attributes listed below that can be maintained only after "Show Details" has been clicked.
  ...
  - **[Terms](https://iliosproject.gitbook.io/ilios-user-guide/schools/vocabularies):** maintain vocabulary terms associated with this course at the course level 
...
2. **Terms**: opens up for the maintenance of Vocabulary Terms to be attached to, or removed from, this Course
