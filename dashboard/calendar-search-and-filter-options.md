...
* [**Courses**](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses) - selected from one or more selected Program Years
* [**Session Types**](https://iliosproject.gitbook.io/ilios-user-guide/schools/session-types)
* [**Terms**](https://iliosproject.gitbook.io/ilios-user-guide/schools/vocabularies) - selected from one or more select Vocabularies
