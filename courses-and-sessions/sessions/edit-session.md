...
Any and all attributes of a session can be modified if you have sufficient permission to do so. Students who only have the student role will not have access to modify sessions. Instructors, Course Directors, and Developers will be able to perform these actions. There will be more granular permissions in future versions of Ilios; but currently, if you have permission to modify sessions, you can modify any session and its attributes.
