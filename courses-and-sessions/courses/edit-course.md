...
**NOTE**: Course Summary Details refers to the higher level details above the "Show Details" button. Refer to [**Course Details**](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses#screen-elements) for the lower level details that require the click of "Show Details" to be shown.
...
3. [**Publishing**](../publishing.md): The Course's publication status can be changed here.
...
6. [**Course Rollover**](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/course_actions/course-rollover): starts the process of rolling this Course over (hidden if a course is locked)
...
* [Competencies](https://iliosproject.gitbook.io/ilios-user-guide/schools/competencies) - read-only values set at School level - Competencies mapped to this course are displayed here (mapped via Program Year objectives).
* [Vocabulary Terms](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/vocabulary_terms) - selected from one or more Vocabularies, which are configured at the [School](https://iliosproject.gitbook.io/ilios-user-guide/schools/vocabularies) level
...
* [Add Objective](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/add-objective)
* [Edit Objective](https://iliosproject.gitbook.io/ilios-user-guide/courses-and-sessions/courses/edit-objective)
...
In this case, we want to add the Doctor of Medicine - BRIDGES Class of 2030 to this course. Click on its label as shown below.
...
Now that the action detailed above has taken place, the School of Medicine - "BRIDGES - Class of 2030" cohort has been successfully attached to the course as shown below.
