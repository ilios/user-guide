...
For more details on viewing and using Ilios with a smaller handheld device, review [Mobile Devices](https://iliosproject.gitbook.io/ilios-user-guide/dashboard/mobile-devices).
